...
try{
		...
		byte [] aadhar = pass.getEncryptedPassword("shivam", salt);
		...
		byte [] party_name = pass.getEncryptedPassword("shivam", salt1);
		System.out.println(""+party_name);
		byte [] salt2 = pass.generateSalt();
		byte [] voter_id = pass.getEncryptedPassword("shivam", salt2);
